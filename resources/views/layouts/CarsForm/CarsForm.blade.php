        ...
        <div class="col-lg-12" style="float: right;">
                             ...
                             <div class="col-lg-12" style="float: right;">
                                <div class="form-group">
                                    ...
                                    <select name="brand" id="brand" v-model="brand" class="form-control" >
                                        <option value="">انتخاب کنید</option>
                               ...
                               <div class="col-lg-12" style="float: right;">
                                    <div class="form-group">
                                        ...
                                        <select name="year" v-model="year" id="year" class="form-control">
                                        <option value="">انتخاب کنید</option>
                                ...
                                <div class="form-group">
                                      ...
                                      کارکرد(کیلومتر)
                                    <input class="form-control" type="text" v-model="run_time" name="run_time">  
                               ...
                               <div class="col-lg-2" style="float: right;">
                                <div class="form-group">
                                  <input class="form-check-input" type="radio" value="2" v-model="adType"  name="type">
                                      درخواستی
                             ...
                             <div class="col-lg-12" style="margin-bottom: 20px;" >
                                <div class="form-group" style="float:left;">
                                      <form action="/addimage" method="post">
                                                 @csrf
                                            <button type="button" class="btn btn-danger" @click="addcars()" style="font-size: 13px;padding: 12px 40px;">
                                                ارسال رایگان آگهی
                                            </button>
                                      </form>
                                  </div>
